...
export const groupsApi = {
  ...
  addCharacter: (groupeId: number, personnageId: number) =>
    api.post(`/groups/${groupeId}/characters`, { personnageId }).then(r => r.data),
  ...
  useConnection: (id: number, connectionId: number) =>
    api.post(`/groups/${id}/use-connection`, { connectionId }).then(r => r.data),
